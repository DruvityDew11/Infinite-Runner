...
function preload(){
    ...
    alienImg = loadImage("./assets/destoryer1.png");
    ...
    shipImg = loadImage("./assets/survivor1.png");
    restart = loadImage ("./assets/restartbutton.jpg")
...
function setup() {
    ...
    */
    ...
    restartbutton = createSprite(600,460,20,21);
    restartbutton.addImage(restart);
    restartbutton.scale = 0.06;0
}

function draw() {
    if(mousePressedOver(restartbutton)){
     //   console.log("backstrech battles nascar popeyes group rblx psx 35 robux");
     background("orange")
    }
    ...
    if(gameState === "END"){
        ...
        fill("White");
        textSize(50);
        text("Game Over kid! Your trash,hahahaha!", 150,300);
